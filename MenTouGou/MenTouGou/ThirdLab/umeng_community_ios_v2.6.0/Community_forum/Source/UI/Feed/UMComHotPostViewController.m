...
{
    UMComPostTableViewController *feedTableViewC = self.childViewControllers[self.currentPage];
...
- (void)createHotFeedsSubViewControllers
{
    ...
    for (int index = 0; index < 4; index ++) {
        ...
        postTableViewC.view.autoresizingMask = UIViewAutoresizingFlexibleHeight;
